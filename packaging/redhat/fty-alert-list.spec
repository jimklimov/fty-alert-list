...
Version:        1.0.0
Release:        1
Summary:        daemon evaluating rules and producing alerts
License:        GPL-2.0+
URL:            https://42ity.org
...
Group:          System/Libraries
Summary:        daemon evaluating rules and producing alerts shared library

%description -n libfty_alert_list0
This package contains shared library for fty-alert-list: daemon evaluating rules and producing alerts
...
%description devel
daemon evaluating rules and producing alerts development tools
This package contains development files for fty-alert-list: daemon evaluating rules and producing alerts
