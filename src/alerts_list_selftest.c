/*  =========================================================================
    alerts_list_selftest.c - run selftests
...
all_tests [] = {
    ...
    { "alerts_list_server", alerts_list_server_test },
...
main (int argc, char **argv)
{
    ...
    for (argn = 1; argn < argc; argn++) {
        ...
        ||  streq (argv [argn], "-h")) {
            puts ("alerts_list_selftest.c [options] ...");
    ...
    if (test) {
        printf ("Running alerts-list test '%s'...\n", test->testname);
        test->test (verbose);
    }
    else
        test_runall (verbose);
